...
class EcomApp:
    ...
    def customer_login(self):
        ...
        try:
            ...
            if customer and customer.get_password() == password:
                self.logged_in_user = customer  # Make sure this line is being executed
    ...
    def remove_from_cart(self):
        try:
            ...
            if self.order_repo.remove_from_cart(self.logged_in_user, product):  # Fix here: use logged_in_user
